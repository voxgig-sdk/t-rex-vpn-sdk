...
func registerTools(server *mcp.Server, client *sdk.TRexVpnSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "t-rex-vpn_list",
		Description: "List records from TRexVpn. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "t-rex-vpn_load",
		Description: "Load a single record from TRexVpn. " +
...
func runOp(client *sdk.TRexVpnSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TRexVpnSDK, name string) (sdk.TRexVpnEntity, error) {
