# TRexVpn TypeScript SDK



The TypeScript SDK for the TRexVpn API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/t-rex-vpn-sdk/releases](https://github.com/voxgig-sdk/t-rex-vpn-sdk/releases)
...
```ts
const client = new TRexVpnSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `TRexVpnSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `TRexVpnSDK.test(testopts?, sdkopts?)` | `TRexVpnSDK` | Create a test-mode client. |
...
| `client` | `client(): TRexVpnSDK` | Return the parent SDK client. |
