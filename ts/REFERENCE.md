# TRexVpn TypeScript SDK Reference

Complete API reference for the TRexVpn TypeScript SDK.
...
#### `TRexVpnSDK.test(testopts?, sdkopts?)`
...
**Returns:** `TRexVpnSDK` instance in test mode.
...
Return the parent `TRexVpnSDK` instance.
