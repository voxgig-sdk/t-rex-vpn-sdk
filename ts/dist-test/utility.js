...
function envOverride(m) {
    if ('TRUE' === process.env.T_REX_VPN_TEST_LIVE ||
        'TRUE' === process.env.T_REX_VPN_TEST_OVERRIDE) {
    ...
    m.T_REX_VPN_TEST_EXPLAIN = process.env.T_REX_VPN_TEST_EXPLAIN || m.T_REX_VPN_TEST_EXPLAIN;
    return m;
}
