# TRexVpn Golang SDK Reference

Complete API reference for the TRexVpn Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TRexVpnSDK`
...
#### `Authentication(data map[string]any) TRexVpnEntity`
