...
func (sdk *TRexVpnSDK) OptionsMap() map[string]any {
...
func (sdk *TRexVpnSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TRexVpnSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TRexVpnSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TRexVpnSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TRexVpnSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TRexVpnSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TRexVpnSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TRexVpnSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TRexVpnSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TRexVpnSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *TRexVpnSDK) Authentication(data map[string]any) TRexVpnEntity {
