...
func registerSDKWords(r *eng.Registry, client *sdk.TRexVpnSDK) {
...
func runOp(client *sdk.TRexVpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
