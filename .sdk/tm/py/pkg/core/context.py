...
from projectname_sdk.core.control import TRexVpnControl
...
class TRexVpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TRexVpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TRexVpnError(code, msg, self)
