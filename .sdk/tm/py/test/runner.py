...
class TRexVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TRexVpnTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TRexVpnTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TRexVpnTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
