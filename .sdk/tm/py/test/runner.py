...
class TRexVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TRexVpnTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TRexVpnTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TRexVpnTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
