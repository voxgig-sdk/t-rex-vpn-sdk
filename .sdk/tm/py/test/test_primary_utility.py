...
from projectname_sdk import TRexVpnSDK
from projectname_sdk.core.spec import TRexVpnSpec
from projectname_sdk.core.result import TRexVpnResult
from projectname_sdk.core.response import TRexVpnResponse
from projectname_sdk.core.operation import TRexVpnOperation
from projectname_sdk.core.error import TRexVpnError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TRexVpnBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TRexVpnSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TRexVpnSDK.test(None, None)
        ...
        class TestInitFeature(TRexVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TRexVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TRexVpnSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TRexVpnSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TRexVpnSDK.test(None, setup_opts)
