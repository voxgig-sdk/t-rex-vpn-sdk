...
// TRexVpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TRexVpnMakeRequest
{
    public static function call(TRexVpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TRexVpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TRexVpnResponse($fetched);
        } else {
