...
// TRexVpn SDK utility: fetcher

class TRexVpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TRexVpnSDK/1.0)';
    ...
    public static function call(TRexVpnContext $ctx, string $fullurl, array $fetchdef): array
    {
