...
class TRexVpnStreamingFeature extends TRexVpnBaseFeature
{
    ...
    private function _iterate(TRexVpnResult $result): \Generator
    {
    ...
    private function _streamable(TRexVpnContext $ctx): bool
    {
