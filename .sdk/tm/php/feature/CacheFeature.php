...
class TRexVpnCacheFeature extends TRexVpnBaseFeature
{
    ...
    private function _through(TRexVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
