...
class TRexVpnRbacFeature extends TRexVpnBaseFeature
{
    ...
    private function _required(TRexVpnContext $ctx): ?string
    {
    ...
    private function _reject(TRexVpnContext $ctx, string $required): void
    {
    ...
    private function _track(TRexVpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
