...
class TRexVpnProxyFeature extends TRexVpnBaseFeature
{
    ...
    public function init(TRexVpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TRexVpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
