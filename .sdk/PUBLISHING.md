...
|---|---|---|
| `ts/` | @voxgig-sdk/t-rex-vpn-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/t-rex-vpn-sdk \
      --repository voxgig-sdk/t-rex-vpn-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/t-rex-vpn-sdk` shows it, and
`npm trust revoke @voxgig-sdk/t-rex-vpn-sdk --id=<id>` removes it.
