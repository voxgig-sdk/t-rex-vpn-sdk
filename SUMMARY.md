...
| --- | --- | --- | --- |
| Authentication | `create` | `POST /auth/login` | See reference |

## Connect to the API

- Production server: `https://t-rex.top/api`
...
- `t-rex-vpn_list`: List records for an entity. No active entity supports this operation.
- `t-rex-vpn_load`: Load one record for an entity. No active entity supports this operation.
