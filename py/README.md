...
The Python SDK for the TRexVpn API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/t-rex-vpn-sdk/releases)) or
...
client = TRexVpnSDK({
    "apikey": os.environ.get("T_REX_VPN_APIKEY"),
})
```
...
```
py/
├── trexvpn_sdk.py         -- Main SDK module
