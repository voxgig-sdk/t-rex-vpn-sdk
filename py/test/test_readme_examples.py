# TRexVpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TRexVpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TRexVpnSDK(...) and TRexVpnSDK.test(...) become
#      TRexVpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "trexvpn_sdk"
_SDK_CLASS = "TRexVpnSDK"
