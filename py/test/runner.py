...
class TRexVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TRexVpnTestRunner.getenv("TREXVPN_TEST_LIVE")
        override = TRexVpnTestRunner.getenv("TREXVPN_TEST_OVERRIDE")
        ...
        explain = TRexVpnTestRunner.getenv("TREXVPN_TEST_EXPLAIN")
