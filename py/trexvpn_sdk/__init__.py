...
from trexvpn_sdk.utility import register

# Load features
from trexvpn_sdk.feature.base_feature import TRexVpnBaseFeature
from trexvpn_sdk.features import _has_feature, _make_feature
...
class TRexVpnSDK:
    ...
    def get_utility(self):
        return TRexVpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TRexVpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Authentication(self, data=None) -> "AuthenticationEntity":
        ...
        from trexvpn_sdk.entity.authentication_entity import AuthenticationEntity
        return AuthenticationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TRexVpnSDK":
        if sdkopts is None:
            sdkopts = {}
