...
class TRexVpnGraphql
{
    ...
    // equivalent.
    public static function body(TRexVpnContext $ctx): mixed
    {
    ...
    public static function errors(TRexVpnContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
