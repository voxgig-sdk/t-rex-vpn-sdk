...
class TRexVpnRatelimitFeature extends TRexVpnBaseFeature
{
    ...
    private function _acquire(TRexVpnContext $ctx): void
    {
    ...
    private function _track(TRexVpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
