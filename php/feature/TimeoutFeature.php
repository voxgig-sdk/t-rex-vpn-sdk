...
class TRexVpnTimeoutFeature extends TRexVpnBaseFeature
{
    ...
    private function _with_timeout(TRexVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TRexVpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
