...
// TRexVpn SDK clienttrack feature
...
class TRexVpnClienttrackFeature extends TRexVpnBaseFeature
{
    ...
    public function PostConstruct(TRexVpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TRexVpn-SDK';
