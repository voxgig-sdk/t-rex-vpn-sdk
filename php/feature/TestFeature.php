...
// TRexVpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TRexVpnTestFeature extends TRexVpnBaseFeature
{
    ...
    public function init(TRexVpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TRexVpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TRexVpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TRexVpnContext $ctx, $op, $args): array
    {
