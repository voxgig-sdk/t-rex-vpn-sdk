...
// TRexVpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TRexVpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TRexVpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(TRexVpnOmni::structfix($val, Struct::undef()))) {
