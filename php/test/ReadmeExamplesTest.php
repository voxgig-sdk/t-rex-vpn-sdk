...
// TRexVpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TRexVpnSDK::test)
...
{
    private const SDK_CLASS = 'TRexVpnSDK';
    ...
    private const SDK_BASE = 'trexvpn_sdk';
